...
with open('V18_Qouaters_1.dat','wb') as wfd:
    for f in ['V18_kepler_lc_out_9.dat','V18_kepler_lc_out_10.dat','V18_kepler_lc_out_12.dat','V18_kepler_lc_out_11.dat','V18_kepler_lc_out_13.dat']:
