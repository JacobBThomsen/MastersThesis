...
plt.plot( ph18, m18 - np.median(m18[i18]), '.',  label = 'Sector 18' )
plt.plot( ph20, m20 - np.median(m20[i20]), '.' , label = 'Sector 20')
plt.plot( ph25, m25 - np.median(m25[i25]), '.' , label = 'Sector 25')
plt.plot( ph26, m26 - np.median(m26[i26]), '.' , label = 'Sector 26')
plt.plot( ph40, m40 - np.median(m40[i40]), '.' , label = 'Sector 40')
plt.plot( ph52, m52 - np.median(m52[i52]), '.' , label = 'Sector 52')
plt.plot( ph53, m53 - np.median(m53[i53]), '.' , label = 'Sector 53')
